...
public abstract class BaseCursorAdaptor<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
          ...
          BaseCursorAdaptor(Context context, Cursor cursor) {
                    mContext = context;
                    mCursor = cursor;
                    mDataValid = cursor != null;
                    mRowIdColumn = mDataValid ? mCursor.getColumnIndex(
                              ERContract.EREntry.EVENT_ID) : -1;
