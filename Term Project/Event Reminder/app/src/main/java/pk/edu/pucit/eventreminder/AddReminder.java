...
class AddReminder extends AppCompatActivity implements
          ...
          private static  ERDBHelper mDBHelper ;

          private static final int
                    EXISTING_VEHICLE_LOADER =
                    24907;

          // TAG to be logged
          private static final String
                    TAG =
                    AddReminder.class.getSimpleName ();
          ...
          protected void onCreate(Bundle savedInstanceState) {
                    ...
                    mDBHelper = new ERDBHelper (this);

                    myToolbar =
                              (Toolbar) findViewById (R.id.AddReminderToolbar);
                    ...
                    clRepeatInterval =
                              findViewById (R.id.RepeatInterval);
                    clRepeatType =
                              findViewById (R.id.RepeatType);
                    ...
                    mTitleText =
                              findViewById (R.id.ReminderTitle);
                    mDateText =
          ...
          public boolean onPrepareOptionsMenu(Menu menu) {
                    ...
                    if (mCurrentReminderUri == null) {
                              MenuItem
                                        menuItem =
                                        menu.findItem (R.id.discard_reminder);
          ...
          private void deleteReminder() {
                    ...
                    if (mCurrentReminderUri != null) {
                              ...
                              int
                                        rowsDeleted =
                                        getContentResolver ().delete (mCurrentReminderUri,
                                                  null, null);
                              ...
                              if (rowsDeleted == 0) {
                                        ...
                                        ERHelper.deleteScheduledAlarm (mCurrentReminderUri,
                                                  getApplicationContext ());
                                        ERHelper.removeNotification (getApplicationContext ());
                    ...
                    if (ERHelper.sameTimeDateExists (values, mDBHelper)) {
                              ...
                              if (mCurrentReminderUri == null) {
                                        ...
                                        Uri
                                                  newUri =
                                                  getContentResolver ()
                                                            .insert (ERContract.EREntry.CONTENT_URI, values);
                                        ...
                                        int
                                                  rowsAffected =
                                                  getContentResolver ()
                                                            .update (mCurrentReminderUri, values,null, null);
          ...
          private String generateTimeInAmOrPm(int hourOfDay, int minute) {
                    ...
                    if (minute < 10) {
                              time =
                                        hourOfDay + ":" + "0" + minute + amOrPm;
                    } else {
                              time =
                                        hourOfDay + ":" + minute + amOrPm;
                    }
                    if (hourOfDay < 10) {
                              time =
                                        "0" + time;
          ...
          public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
                    try {
                              ...
                              if (cursor.moveToFirst ()) {
                                        int
                                                  titleColumnIndex =
                                                  cursor.getColumnIndex (ERContract.EREntry.EVENT_TITLE);
                                        int
                                                  dateColumnIndex =
                                                  cursor.getColumnIndex (ERContract.EREntry.EVENT_DATE);
                                        int
                                                  timeColumnIndex =
                                                  cursor.getColumnIndex (ERContract.EREntry.EVENT_TIME);
                                        int
                                                  repeatColumnIndex =
                                                  cursor.getColumnIndex (ERContract.EREntry.EVENT_REPEAT);
                                        int
                                                  repeatNoColumnIndex =
                                                  cursor.getColumnIndex (ERContract.EREntry.EVENT_REPEAT_NO);
                                        int
                                                  repeatTypeColumnIndex =
                                                  cursor.getColumnIndex (ERContract.EREntry.EVENT_REPEAT_TYPE);
                                        ...
                                        String
                                                  repeat =
                                                  cursor.getString (repeatColumnIndex);
                                        String
                                                  repeatNo =
                                                  cursor.getString (repeatNoColumnIndex);
                                        String
                                                  repeatType =
                                                  cursor.getString (repeatTypeColumnIndex);
