...
public class MainActivity extends AppCompatActivity {
          ...
          //    Expression e = null;
          private Stack
                    equationHandlingStack =
                    new Stack ();
          private Stack
                    equationHandlingStack2 =
                    new Stack ();
          private TextView
                    tv_equeation;
          private TextView
          ...
          private View.OnClickListener
                    ...
                    new View.OnClickListener () {
                              ...
                              public void onClick(View v) {
                                        tv_equeation =
                                                  (TextView) findViewById (R.id.tv_equation);
                                        switch (v.getId ()) {
                                                  case R.id.tv_1:
          ...
          private void handleEquationOnStack(String val) {
                    if (!val.equals ("+") && !val.equals ("-") && !val.equals ("x") && !val.equals ("/") && !val.equals ("%")) {
                              String
                                        stTop =
                                        equationHandlingStack.pop ().toString ();
                              ...
                              String
                                        stTop =
                                        equationHandlingStack.peek ().toString ();
                              if (!stTop.equals ("+") && !stTop.equals ("-") && !stTop.equals ("x") && !stTop.equals ("/") && !stTop.equals ("%")) {
                                        equationHandlingStack.push (val);
                              } else {
                                                  ...
                                                  if (!equationHandlingStack.empty ()) {
                                                            ...
                                                            if (!stTop.equals ("+") && !stTop.equals ("-") && !stTop.equals ("x") && !stTop.equals ("/") && !stTop.equals ("%")) {
                                                                      ...
                                                                      if (!top.equals ("")) {
                                                                                String
                                                                                          valueToBePushed =
                                                                                          top.subSequence (0, top.length () - 1).toString ();
...
//                tv_result.setText(result);
          ...
          private void setUpTextViews() {
                    ...
                    tv_6 =
                              (TextView) findViewById (R.id.tv_6);
                    tv_7 =
                              (TextView) findViewById (R.id.tv_7);
                    tv_8 =
                              (TextView) findViewById (R.id.tv_8);
                    tv_9 =
                              (TextView) findViewById (R.id.tv_9);
                    tv_0 =
                              (TextView) findViewById (R.id.tv_singleZero);
                    tv_00 =
                              (TextView) findViewById (R.id.tv_doubleZero);

                    //getting symbols
                    tv_sub =
                              (TextView) findViewById (R.id.tv_subtract);
                    tv_add =
                              (TextView) findViewById (R.id.tv_addition);
                    tv_mul =
                              (TextView) findViewById (R.id.tv_multiply);
                    tv_div =
                              (TextView) findViewById (R.id.tv_divide);
                    tv_rmd =
                              (TextView) findViewById (R.id.tv_remainder);
                    tv_equals =
                              (TextView) findViewById (R.id.tv_equals_to);
                    ;

                    //getting additional buttons
                    tv_ac =
                              (TextView) findViewById (R.id.tv_ac);
                    tv_del =
                              (TextView) findViewById (R.id.tv_delete);
                    tv_dot =
          ...
          private String computeEquation() {
                    ...
                    while (!equationHandlingStack2.empty ()) {
                              stTop =
                                        equationHandlingStack2.pop ().toString ();
                              if (stTop.equals ("-")) {
                                        stTop =
                                                  "-" + equationHandlingStack2.pop ().toString ();
                                        if (counter != 0) {
                                        ...
                                        if (opertion.equals (MUL)) {
                                                  if (stTop.indexOf (".") >= 0 || val2.indexOf (".") >= 0) {
                                                            operationResultDouble =
                                                                      Double.parseDouble (stTop) * Double.parseDouble (val2);
                                                            equationHandlingStack.push (operationResultDouble.toString ());
                                                  } else {
                                                            operationResultInt =
                                                                      Integer.parseInt (stTop) * Integer.parseInt (val2);
